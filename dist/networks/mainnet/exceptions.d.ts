...
export declare const outlookTable: {
...
export declare namespace transactionIdFixTable {
    export const ca764c01dd78f93393b02f7f6c4f0c12ed8e7ca26d3098e91d6e461a238a6b33: string;
}
export declare const wrongTransactionOrder: {
    "11773170219525190460": string[];
    "5847703302374058501": string[];
};
export declare const negativeBalances: {
